...
class My_Callback(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        print(v0_h0.shape)
        print(v1_h0.shape)
        print(v0_h0_abs.shape)
        print(v1_h0_abs.shape)
        ...
        print(v3,)
        print([str(x) for x in v3.flatten()])
        print(v5,type(v5))
...
for dataType in dataTypeList:
    x_url = os.path.join(dataDir, dataType, 'VTE4.csv'); print(x_url)
    y_url = os.path.join(dataDir, dataType, 'gamma.csv');
